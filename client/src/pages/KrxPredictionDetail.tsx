              ...
              <div className="relative my-8 space-y-8">
                ...
                <div className="relative">
                  ...
                  <div className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 rounded-lg shadow-sm">
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      ...
                      <span className="bg-emerald-100 text-emerald-800 px-2 py-1 rounded-full text-xs">베이스: krx-qwen2-7b-instruct-v2</span>
                    </div>
                ...
                <div className="relative">
                  ...
                  <div className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 rounded-lg shadow-sm">
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded-full text-xs">베이스: V2</span>
