              ...
              <div className="relative my-8 space-y-8">
                ...
                <div className="relative">
                  ...
                  <div className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 rounded-lg shadow-sm">
                    ...
                    <p className="text-xs text-gray-700 mt-3 italic">논문: "<a href="#" className="text-primary-600 hover:underline">Don't Stop Pretraining: Adapt Language Models to Domains and Tasks</a>" (Gururangan et al., 2020)</p>
                  </div>
                </div>
                  ...
                  <div className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 rounded-lg shadow-sm">
                    ...
                    <div className="bg-slate-50 p-3 rounded-md mb-3">
                      ...
                      <div className="bg-blue-50 p-2 rounded-md text-center mb-3">
                        <div className="text-xs text-gray-500 mb-1">전체 평균</div>
                        <div className="text-sm font-medium text-blue-700">0.44 → 0.50 (+14%)</div>
                      </div>
                      <div className="grid grid-cols-3 gap-2 mb-2">
                        <div className="bg-blue-50 p-2 rounded-md text-center">
                          <div className="text-xs text-gray-500 mb-1">국내기업</div>
                          <div className="text-sm font-medium text-blue-700">0.51 → 0.61 (+20%)</div>
                        </div>
                        <div className="bg-blue-50 p-2 rounded-md text-center">
                          <div className="text-xs text-gray-500 mb-1">재무회계</div>
                          <div className="text-sm font-medium text-blue-700">0.27 → 0.34 (+26%)</div>
                        </div>
                        <div className="bg-blue-50 p-2 rounded-md text-center">
                          <div className="text-xs text-gray-500 mb-1">주가예측</div>
                          <div className="text-sm font-medium text-blue-700">0.54 → 0.55 (+2%)</div>
                        </div>
                        <div className="bg-blue-50 p-2 rounded-md text-center">
                          <div className="text-xs text-gray-500 mb-1">금융에이전트</div>
                          <div className="text-sm font-medium text-blue-700">0.62 → 0.66 (+6%)</div>
                        </div>
                        <div className="bg-blue-50 p-2 rounded-md text-center">
                          <div className="text-xs text-gray-500 mb-1">금융시장</div>
                          <div className="text-sm font-medium text-blue-700">0.26 → 0.35 (+35%)</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <p className="text-xs text-gray-700 mt-3 italic">논문: "<a href="#" className="text-primary-600 hover:underline">Adapting Large Language Models to Domains via Reading Comprehension</a>" (Yuxian et al., 2023)</p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 rounded-lg shadow-sm">
                    ...
                    <p className="text-xs text-gray-700 mt-3 italic">논문: "<a href="#" className="text-primary-600 hover:underline">QLoRA: Efficient Finetuning of Quantized LLMs</a>" (Dettmers et al., 2023)</p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="bg-gradient-to-r from-primary-50 to-primary-100 p-4 rounded-lg shadow-sm">
                    ...
                    <p className="text-xs text-gray-700 mt-3 italic">논문: "<a href="#" className="text-primary-600 hover:underline">Task-specific Fine-tuning of Large Language Models</a>" (Wei et al., 2022)</p>
                  </div>
                </div>
              </div>
